...
- OpenAPI client: `src/erd-visualizer/ui/lib/api/` (auto-generated)
- Routes: `src/erd-visualizer/ui/routes/`
- Components: `src/erd-visualizer/ui/components/`
- Backend: `src/erd-visualizer/backend/`
